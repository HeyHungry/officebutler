...
// The menu is defined in `menuCategories` at the top. We can remove the Deals category.
...
code = code.replace(targetCategory, '');

fs.writeFileSync('src/pages/GuestOrdering.tsx', code);
console.log("Removed Deals from GuestOrdering");
